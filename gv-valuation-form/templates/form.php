    ...
    <form class="gvval-form" novalidate>
        ...
        <div class="gvval-steps" style="min-height:var(--gv-step-min-h,480px);">
            ...
            <section class="gvval-step" data-step="7">
                <h3>Príslušenstvo</h3>
                <div class="gvval-accessories-layout">
                    <div class="gvval-accessories-main">
                    ...
                    <div class="gvval-accessories-side">
                        ...
                        <div class="gvval-nested gvval-nested-inline gvval-parking-slots" data-toggle="parking">
